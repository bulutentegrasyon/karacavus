...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="m-0">Yeni Müşteri Yorumu</h1>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="author_name" class="form-control @error('author_name') is-invalid @enderror"
                                       value="{{ old('author_name') }}" required placeholder="A** V***">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="author_company" class="form-control"
                                       value="{{ old('author_company') }}" placeholder="ABC Yapı A.Ş.">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea name="content" class="form-control @error('content') is-invalid @enderror"
                                  rows="4" required placeholder="Müşteri yorumu...">{{ old('content') }}</textarea>
