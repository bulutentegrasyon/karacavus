...
return [
    ...
    */
    ...
    'title' => 'Karacavus Hafriyat - Yönetim',
    'title_prefix' => '',
    'title_postfix' => '',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'active'  => ['admin/posts*'],
            'submenu' => [
                ['text' => 'Tüm Yazılar',  'url' => 'admin/posts',                'icon' => 'fas fa-fw fa-list'],
                ['text' => 'Yeni Yaz',     'url' => 'admin/posts/create',         'icon' => 'fas fa-fw fa-plus'],
                ['text' => 'Kategoriler',  'url' => 'admin/blog-categories',      'icon' => 'fas fa-fw fa-tags'],
            ],
        ],
        [
            'text'   => 'Hizmetler',
            ...
            'submenu' => [
                ['text' => 'Tüm Hizmetler', 'url' => 'admin/services',        'icon' => 'fas fa-fw fa-list'],
                ['text' => 'Yeni Hizmet',   'url' => 'admin/services/create', 'icon' => 'fas fa-fw fa-plus'],
            ],
        ],
        [
            'text'   => 'Projeler',
            ...
            'submenu' => [
                ['text' => 'Tüm Projeler', 'url' => 'admin/projects',        'icon' => 'fas fa-fw fa-list'],
